...
def trainCnnLightPersonal():
    ...
    #         # print("trainPatients=",trainPatients)
        ...
        # print()
        # measure performance
        AllRes_test[patIndx, 0:9] = performance_sampleAndEventBased(predLabels_test, test_labels_for_visual, PerformanceParams)
        ...
        AllRes_test[patIndx, 9:18] = performance_sampleAndEventBased(predLabels_MovAvrg, test_labels_for_visual, PerformanceParams)
        ...
        AllRes_test[patIndx, 18:27] = performance_sampleAndEventBased(predLabels_Bayes, test_labels_for_visual, PerformanceParams)
