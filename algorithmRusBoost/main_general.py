...
def trainRusGeneral():
    ...
    TrueAnnotationsFile = outDir + '/' + dataset + 'AnnotationsTrue.csv'#123123
    annotationsTrue=pd.read_csv(TrueAnnotationsFile)
    ...
    for patIndx, pat in enumerate(GeneralParams.patients):
        ...
        #####################################
        # CREATE ANNOTATION FILE DIRECTLY
    ...
    for patIndx, pat in enumerate(GeneralParams.patients):
        print(pat)
        InName = outPredictionsFolder + '/Subj' + pat + '_' + 'Transformer' + '_TestPredictions.csv.parquet.gzip'
        ...
        # outName_ROC = outPredictionsFolder + pat + '_PredictionsInTimeROCLoad'
